...
namespace MatchBetting.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public IList<SelectListItem> CompetitionGroups { get; set; } = [];
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            CompetitionGroups = await _context.CompetitionGroups
                .Where(g => g.isactive)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CompetitionGroupCompetitionId = SelectedCompetitionGroupId;
